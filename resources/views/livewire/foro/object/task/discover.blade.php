        ...
        <x-object.section>
            <div class="py-3 justify-start items-start inline-flex">
                    ...
                    <div class="max-w-2xl  px-4 py-4 mx-auto bg-white rounded-lg shadow-md ">
                        ...
                        <div class="flex items-center justify-self-auto mt-4">
                            <input class="appearance-none rounded-none relative block w-96 px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-default focus:border-default focus:z-10 sm:text-sm" placeholder="Comenta">
    
                            <div class="flex items-center space-x-2">
    
                                <div class="rounded-full h-16 w-16 flex items-center justify-center text-2xl ml-2 py-2 px-2">
                                    <i class="fas fa-location-arrow "></i>
                                </div>
                                
                                <div class="rounded-full h-16 w-16 flex items-center justify-center text-2xl py-2 px-2">
