  ...
  <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
    <div class="relative flex items-center justify-between h-16">
      ...
      <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
        ...
        <div class="flex-shrink-0 flex items-center">
          <img class="block lg:hidden h-8 w-auto" src="{{asset('storage/icon/titulo.svg')}}" alt="Workflow">
          <img class="hidden lg:block h-8 w-auto" src="{{asset('storage/icon/titulo.svg')}}" alt="Workflow">
        </div>
          <img class="hidden lg:block h-8 w-auto" src="{{asset('storage/icon/titulo.svg')}}" alt="Workflow">
        </div>
      ...
      <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
        <button type="button" class="bg-gray-800 p-1 mr-2 rounded-full text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
